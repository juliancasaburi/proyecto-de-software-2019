...
(function(a){"function"===typeof define&&define.amd?define(["jquery","datatables.net"],function(b){return a(b,window,document)}):"object"===typeof exports?module.exports=function(b,c){b||(b=window);c&&c.fn.dataTable||(c=require("datatables.net")(b,c).$);return a(c,b,b.document)}:a(jQuery,window,document)})(function(a,b,c,e){var d=a.fn.dataTable;a.extend(!0,d.defaults,{dom:"<'mdl-grid'<'mdl-cell col s6'l><'mdl-cell col s6'f>><'mdl-grid dt-table'<'mdl-cell col s12'tr>><'mdl-grid'<'mdl-cell col s4'i><'mdl-cell col s8'p>>",
...
var q=0;for(e=d.length;q<e;q++){var f=d[q];if(a.isArray(f))u(c,f);else{g="";var p=!1;switch(f){case "ellipsis":g="&#x2026;";h="disabled";break;case "first":g=n.sFirst;h=f+(0<m?"":" disabled");break;case "previous":g=n.sPrevious;h=f+(0<m?"":" disabled");break;case "next":g=n.sNext;h=f+(m<r-1?"":" disabled");break;case "last":g=n.sLast;h=f+(m<r-1?"":" disabled");break;default:g=f+1,h="",p=m===f}p&&(h+="teal waves-effect waves-light");g&&(p=a("<button>",{"class":"btn teal waves-effect waves-light "+h,id:0===w&&"string"===
